...
RUN apt-get install -y daemon libpoppler-dev libgirepository-1.0 poppler-utils graphicsmagick build-essential zlib1g-dev libreadline-dev mongodb-clients
